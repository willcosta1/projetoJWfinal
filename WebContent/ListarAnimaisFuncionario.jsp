...
<title>Animais para adoção</title>
	...
	<f:view>
	<h:form>
	<h:dataTable id="adocado" value="#{animalController.listarAnimaisFuncionario}" var="animaladocao" styleClass="table">
		...
		<h:column>
				...
				<h:commandLink value="Excluir" action="#{animalController.excluir}">
					<f:param name="id" value="#{animaladocao.idAnimal}" />
				</h:commandLink>				
		</h:column>	
		<h:column>
				<f:facet name="header">					
				</f:facet>
				<h:commandLink value="Alterar " action="#{animalController.alterar}">
					<f:param name="id" value="#{animaladocao.idAnimal}" />
				</h:commandLink>
